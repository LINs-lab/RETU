#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/general/ckpt10800/best_hparams.json.
...
output_scene="general"
sft_scene="general"
rl_start_point=10800
max_step="auto"
model_name="qwen_2_5_7b"
rl_method="dapo"
sft_steps=(0 360 720 1080 1440 1800 3600 5400 7200 9000 10800 12600 14080)

sft_dict_file_name="general_flops2valPerform_sft_dict.pkl"
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_general_dapo_10800_max_step_auto_fit16_hparam_best.png"
