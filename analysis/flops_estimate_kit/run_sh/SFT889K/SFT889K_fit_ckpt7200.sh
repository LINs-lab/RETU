#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/general/ckpt7200/best_hparams.json.
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_general_dapo_7200_max_step_auto_fit13_hparam_best.png"
