#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/uniform102K/ckpt1080/best_hparams.json.
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_uniform102K_dapo_1080_max_step_auto_ts10_fp60_hparam_best.png"
