#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/uniform102K/ckpt1440/trial_metrics.json.
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_uniform102K_dapo_1440_max_step_auto_fit53_fp53_rob0_lts0.75_ot2.5_vm100.png"
