#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/uniform102K/ckpt1800/trial_metrics.json.
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_uniform102K_dapo_1800_max_step_auto_fit59_ts0_fp59_rob0_lts0.75_ot2.5_vm100.png"
