#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/s1K/ckpt124/best_hparams.json.
...
rl_method="dapo"
sft_steps=(0 62 124 186 248 310)

sft_dict_file_name="s1K_flops2valPerform_sft_dict.pkl"
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_s1K_dapo_124_max_step_auto_ts0_fp55_hparam_best.png"
