#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/s1K/ckpt62/best_hparams.json.
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_s1K_dapo_62_max_step_auto_ts12_fp75_hparam_best.png"
