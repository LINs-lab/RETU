#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/hard102K/ckpt1800/trial_metrics.json.
...
sft_dict_file_name="hard102K_flops2valPerform_sft_dict_0422.pkl"
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_hard102K_dapo_1800_max_step_auto_fit27_fp27_rob0_lts0.75_ot2.5_vm100.png"
