#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/hard102K/ckpt1440/best_hparams.json.
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_hard102K_dapo_1440_max_step_auto_fit26_hparam_best.png"
