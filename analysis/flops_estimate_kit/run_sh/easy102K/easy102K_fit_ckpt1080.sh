#!/usr/bin/env bash
# Auto-generated from analysis/flops_estimate_kit/fit_res/easy102K/ckpt1080/trial_metrics.json.
...
rl_method="dapo"
sft_steps=(0 360 720 1080 1440 1800 6120)

sft_dict_file_name="easy102K_flops2valPerform_sft_dict.pkl"
...
mkdir -p "${out_dir}"
figure_save_path="${out_dir}/qwen_2_5_7b_sft_easy102K_dapo_1080_max_step_auto_fit63_fp63_rob0_lts0.75_ot2.5_vm100.png"
