...
class ActorConfig(BaseConfig):
    ...
    use_sft_prefix_reward: bool = False
    use_sft_reward: bool = False
    ...
    sft_prefix_reward_weight: float = 1.0
    all_max_clip: float = -1.0
    use_ppo_kl_loss: bool = False # upt arg
    ppo_kl_loss_coef: float = 0.01 # upt arg
    use_adaptive_temperature: bool = False # upt arg
    use_adaptive_temperature_fixed: bool = False # upt arg
    adaptive_temperature_clip: float = -1.0 # upt arg
    adaptive_temperature_target_entropy: float = 1.0 # upt arg
    alpha_lr:float =  1e-2 # upt arg
    debug: bool =False # upt arg
    use_target_lst: bool = False # upt arg
    loss_remove_token_mean: bool = False # upt arg
    loss_remove_clip: bool = False # upt arg
    sft_loss_coef: float = 1.0 # upt arg
    use_sft_multitask_loss: bool = False # upt arg
    offline_loss_type: str = "off_policy" # upt arg
    srft_type: str = "paper" # upt arg
